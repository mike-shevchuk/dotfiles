...
argument-hint: "[ref-name or path to .lgtm/reviews/<ref>/]"
---

# LGTM listen — live comment→Claude loop

You are the Claude side of the LGTM live loop (design: `.lgtm/design.md` §3).
